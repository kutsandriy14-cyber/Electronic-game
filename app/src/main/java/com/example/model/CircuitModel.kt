...
enum class ComponentType(val category: ComponentCategory) {
    ...
    WATER_PUMP(ComponentCategory.HYDRAULICS),
    ...
    WATER(ComponentCategory.HYDRAULICS),
    LAVA(ComponentCategory.HYDRAULICS),
    OIL(ComponentCategory.HYDRAULICS),
    ACID(ComponentCategory.HYDRAULICS),
    ...
    GASOLINE(ComponentCategory.HYDRAULICS),
    LIQUID_NITROGEN(ComponentCategory.HYDRAULICS),
    URANIUM(ComponentCategory.MATERIALS),
    MAGIC_DUST(ComponentCategory.MATERIALS),
    PIPE(ComponentCategory.HYDRAULICS),
    ...
    PRESSURE_SENSOR(ComponentCategory.HYDRAULICS),
